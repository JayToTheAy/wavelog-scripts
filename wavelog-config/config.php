...
$config['callbook'] = 'qrz'; // Options are hamqth, qrz or qrzcq
...
$config['qrz_username'] = 'AK6EU';
$config['qrz_password'] = '29pojiqrz';
...
*/
$config['hamqth_username'] = 'AK6EU';
$config['hamqth_password'] = 'hch4ecn0RHU.mxb7mwh';
